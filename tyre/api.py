...
def job_card(data,brand,model):
    ...
    service = {"alignment": val.Alignment, "rotation": val.Rotation, "oil_change": val.Oil_change, "balancing": val.Balancing, "inflation": val.Inflation,
                ...
                "rim": val.rotations['rim'], "wheel": val.rotations['wheel'], "oil_quality": val.oil_changes['oil_quality'], "oil_quantity": val.oil_changes['oil_quantity'],"custom_inches":val.balancings['inches'],"custom_type":val.balancings['type'],"custom_grams_check":val.balancings['gramsCheck'], "front_left_gm": val.balancings['fl'],
